...
const MultiSelect = (props: MultiSelectProps) => {
    ...
    const [fullWidth, setFulWidth] = useState(props.width || "w-100p");
    ...
    return (
        <div className={`multiselect${props.disabled ? " disabled" : ""}${props.readOnly ? " readonly" : ""} ${fieldWidth}`}
            ref={(ref: any) => {
                if (ref) {
